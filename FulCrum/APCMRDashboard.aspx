<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/FulcrumMaster.Master" CodeBehind="APCMRDashboard.aspx.cs" Inherits="Fulcrum.APCMRDashboard" %>
                                    ...
                                    <div>
                                        <div class="dashboardDiv1 dashboardOuterDiv">
                                            <div class="dashboardOuterDiv01">
                                                <asp:ImageButton ID="ImageButton3" ImageUrl="Images/field-data-entry.png" runat="server" PostBackUrl="APCMRPreInspectionDataEntry.aspx" AlternateText="Pre Inspection Data Entry" CssClass="vAlignBottom" /></div>
                                            <div class="dashboardOuterDiv02"><a href="APCMRPreInspectionDataEntry.aspx">PRE INSPECTION DATA ENTRY</a></div>
                                        </div>
                                         <div class="dashboardDiv1 dashboardOuterDiv">
                                            <div class="dashboardOuterDiv01">
                                                <asp:ImageButton ID="ImageButton1" ImageUrl="Images/field-data-entry.png" runat="server" PostBackUrl="APCMRPostInspectionDataEntry.aspx" AlternateText="Post Inspection Data Entry" CssClass="vAlignBottom" /></div>
                                            <div class="dashboardOuterDiv02"><a href="APCMRPostInspectionDataEntry.aspx">POST INSPECTION DATA ENTRY</a></div>
                                        </div>
                                        <div class="dashboardDiv1 dashboardOuterDiv">
                                            <div class="dashboardOuterDiv01">
                                                <asp:ImageButton ID="ImageButton4" ImageUrl="Images/jobadata.png" runat="server" PostBackUrl="APCMRJobData.aspx" AlternateText="Job Data" CssClass="vAlignBottom" /></div>
                                            <div class="dashboardOuterDiv02"><a href="APCMRJobData.aspx">JOB DATA</a></div>
                                        </div>
