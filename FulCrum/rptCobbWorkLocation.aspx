<%@ Page Language="C#" MasterPageFile="~/FulcrumMaster.Master" AutoEventWireup="true" CodeBehind="rptCobbWorkLocation.aspx.cs" Inherits="FulCrum.rptCobbWorkLocation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div class="wrapper">
        ...
        <div class="container-fluid">
              <p class="pageHeading">Work Location Report</p>
                ...
                <telerik:ReportViewer ID="ReportViewer1" runat="server" Width="1050px" ShowPrintButton="false"
                    ...
                    Report="FulCrumReport_Lib.CobbMakeReadyWorkLocations, FulCrumReport_Lib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" Resources-ExportSelectFormatText="Export to the selected format">
