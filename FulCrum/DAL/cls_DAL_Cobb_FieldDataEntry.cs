...
namespace DAL
{
    public class cls_DAL_Cobb_FieldDataEntry
    {
        ...
        public static DataSet MasterData_GetList()
        {
            ...
            string cmd = "SP_COBB_FIELD_MASTER_DATA_GETLIST";
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_GET_POLE_DETAILS";
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_INSERT";
            SqlParameter[] commandParameters =
               {
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_POA_CREATE";
            SqlParameter[] commandParameters =
            {
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_POA_DELETE";
            SqlParameter[] commandParameters =
             {
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_MIDSPAN_CREATE";
            SqlParameter[] commandParameters =
            {
                new SqlParameter("@TrackingId",SqlDbType.VarChar,50),
                new SqlParameter("@POLE_ID",SqlDbType.VarChar,50),
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_MIDSPAN_DELETE";
            SqlParameter[] commandParameters =
            {
                new SqlParameter("@RecordId",SqlDbType.VarChar,100),
                new SqlParameter("@ChildRecordId",SqlDbType.VarChar,100)
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_NOTES_CREATE";
            SqlParameter[] commandParameters =
            {
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_NOTES_DELETE";
            SqlParameter[] commandParameters =
            {
                new SqlParameter("@Id",SqlDbType.Int),
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_GET_TRACKING_POLE_LIST";
            SqlParameter[] commandParameters =
            {
                new SqlParameter("@tracking_no",SqlDbType.VarChar,100)
            };
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_CHECK_VIOLATION";
            SqlParameter[] commandParameters =
            {
                new SqlParameter("@TrackingId",SqlDbType.VarChar,100),
                new SqlParameter("@PoleId",SqlDbType.VarChar,100)
        ...
        {
            string dsn = clsConfiguration.CurrentConfig.ConnectionString;
            string cmd = "SP_COBB_FIELD_DATA_CHECK_VIOLATION_MIDSPAN";
            SqlParameter[] commandParameters =
            {
                new SqlParameter("@TrackingId",SqlDbType.VarChar,100),
                new SqlParameter("@PoleId",SqlDbType.VarChar,100)
