...
namespace Fulcrum
{
    public partial class CobbJobData : BasePage
    {
        #region PageLoad
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    DataSet dsMaster = BAL.clsBAL_Cobb_JobData.JobMasterData_GetList();
        ...
        protected void BindJobData()
        {
            try
            {
                ...
                DataSet ds = BAL.clsBAL_Cobb_JobData.GetJobDetails(TrackingId);
        ...
        public void PermiteeList()
        {
            ...
            {
                string TrackingId = ddlTrackingNo.SelectedItem.Value;
                DataSet ds = BAL.clsBAL_Cobb_JobData.GetPermiteeList(TrackingId);
            ...
            try
            {
                if (e.Item.IsInEditMode)
                {
                    ...
                    if (CompanyName != "")
                    {
                        ...
                        int result = BAL.clsBAL_Cobb_JobData.EditPermitee_Insert(TrackingId, CompanyName, Permitee);
                        if (result > 0)
                        {
        ...
        protected void btn_JobInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objJobData.Reference = "";
                objJobData.Workorder = "";
                ...
                int result = BAL.clsBAL_Cobb_JobData.JobData_Insert(objJobData);
                if (result > 0)
                {
