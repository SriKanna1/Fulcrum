<%@ Page Language="C#" MasterPageFile="~/FulcrumMaster.Master"  AutoEventWireup="true" CodeBehind="rptEstimatedCost.aspx.cs" Inherits="Fulcrum.rptEstimatedCost" %>
        ...
        <div class="container-fluid">
             <p class="pageHeading">Estimated Cost Report</p>
               ...
               <telerik:ReportViewer ID="ReportViewer1" runat="server" Width="1050px" ShowPrintButton="false"
                ...
                Report="FulCrumReport_Lib.EstimatedCostReport, FulCrumReport_Lib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" Resources-ExportSelectFormatText="Export to the selected format">
