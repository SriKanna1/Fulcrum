<%@ Page Title="" Language="C#" MasterPageFile="~/FulcrumMaster.Master" AutoEventWireup="true" CodeBehind="JobData.aspx.cs" Inherits="Fulcrum.JobData" %>
                            ...
                            <div class="w3-half">
                                <div class="w3-row-padding padding-none">
                                    ...
                                    <div class="w3-third">
                                        ...
                                        <asp:TextBox ID="txt_JobName" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="w3-third">
                                        &nbsp;
                                    </div>
                                    ...
                                    <MasterTableView EditMode="InPlace" CommandItemDisplay="Top" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
                                        <CommandItemTemplate>
                                            <div style="padding:5px 5px;">
                                                <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="Blue" Font-Bold="true" CommandName="InitInsert" Visible='<%# !rg_Permitee.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle; width:20px; height:18px;" alt="" src="Images/Add-new1.png"/> &nbsp;Add New Company</asp:LinkButton>
                                            </div>
                                        </CommandItemTemplate> 
                                        <Columns> 
