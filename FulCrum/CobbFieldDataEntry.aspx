<%@ Page Title="" Language="C#" MasterPageFile="~/FulcrumMaster.Master" AutoEventWireup="true" CodeBehind="CobbFieldDataEntry.aspx.cs" Inherits="Fulcrum.CobbFieldDataEntry" %>
                        ...
                        <div class="w3-row-padding">
                            <div class="w3-half">
                                <div class="w3-row-padding padding-none">
                                    ...
                                    <div class="w3-quarter">
                                        <label>CommMap# &nbsp;</label><br />
                                        <%--<asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvCommMap" ValidationGroup="A" runat="server" Text="*" ErrorMessage="Please Enter CommMap#" ForeColor="Red" ControlToValidate="txtCommMap" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                ...
                                <div class="w3-row-padding padding-none">
                                    ...
                                    <div class="w3-half">
                                        <label>Cobb Construction Cost ($) &nbsp;</label><%--<asp:RequiredFieldValidator SetFocusOnError="true" ID="rfvConstructionCost" ValidationGroup="A" runat="server" Text="*" ErrorMessage="Please Enter GPC Construction Cost" ForeColor="Red" ControlToValidate="txtConstructionCost" Display="Dynamic"></asp:RequiredFieldValidator>--%><br />
                                        ...
                                        <MasterTableView EditMode="InPlace" EnableHeaderContextMenu="true" CommandItemDisplay="Top" TableLayout="Fixed" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage">
                                            ...
                                            <CommandItemTemplate>
                                                <div style="padding: 5px 5px;">
                                                    <asp:LinkButton ID="LinkButton1" ValidationGroup="A" runat="server" ForeColor="Blue" Font-Bold="true" CommandName="InitInsert" Visible='<%# !rg_POA.MasterTableView.IsItemInserted %>'>  &nbsp;Add New POM</asp:LinkButton>
                                                </div>
                                            </CommandItemTemplate>
                                            <ColumnGroups>
                                ...
                                <div style="width: 680px; height: 435px; overflow-y: auto;">
                                    <Telerik:RadGrid ID="rg_Midspans" runat="server" RenderMode="Lightweight" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Left" ItemStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Left" AllowSorting="false" AutoGenerateColumns="False" TabIndex="99" TableLayout="Fixed"
                                        ...
                                        <MasterTableView EditMode="InPlace" TableLayout="Fixed" CommandItemDisplay="Top" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
                                            ...
                                            <CommandItemTemplate>
                                                <div style="padding: 5px 5px;">
                                                    <asp:LinkButton ID="LinkButton2" ValidationGroup="A" runat="server" ForeColor="Blue" Font-Bold="true" CommandName="InitInsert" Visible='<%# !rg_Midspans.MasterTableView.IsItemInserted %>'>  &nbsp;Add New Midspan</asp:LinkButton>
                                                </div>
                                            </CommandItemTemplate>
                                            <ColumnGroups>
                                ...
                                <div style="width: 1280px; height: 435px; overflow-y: auto;">
                                    <Telerik:RadGrid ID="rg_Notes" runat="server" RenderMode="Lightweight" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Left" ItemStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Left" AllowSorting="false" AutoGenerateColumns="False" TabIndex="99" TableLayout="Fixed"
                                        ...
                                        <MasterTableView EditMode="InPlace" CommandItemDisplay="Top" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
                                            <CommandItemTemplate>
                                                <div style="padding: 5px 5px;">
                                                    <asp:LinkButton ID="LinkButton2" ValidationGroup="A" runat="server" ForeColor="Blue" Font-Bold="true" CommandName="InitInsert" Visible='<%# !rg_Notes.MasterTableView.IsItemInserted %>'>  &nbsp;Add New Notes</asp:LinkButton>
                                                </div>
                                            </CommandItemTemplate>
                                            <Columns>
