<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/FulcrumMaster.Master" CodeBehind="rptCobbWorkLocationImage.aspx.cs" Inherits="FulCrum.rptCobbWorkLocationImage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div class="wrapper">
        ...
        <div class="container-fluid">
              <p class="pageHeading">Work Location Image Report</p>
                ...
                <telerik:ReportViewer ID="ReportViewer1" runat="server" Width="1050px" ShowPrintButton="false"
                    ...
                    Report="FulCrumReport_Lib.CobbMakeReady_WorkLocationImage, FulCrumReport_Lib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" Resources-ExportSelectFormatText="Export to the selected format">
