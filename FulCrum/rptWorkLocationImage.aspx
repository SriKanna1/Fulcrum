<%@ Page Language="C#" MasterPageFile="~/FulcrumMaster.Master" AutoEventWireup="true" CodeBehind="rptWorkLocationImage.aspx.cs" Inherits="Fulcrum.rptWorkLocationImage" %>
        ...
        <div class="container-fluid">
              <p class="pageHeading">Work Location Image Report</p>
                ...
                <telerik:ReportViewer ID="ReportViewer1" runat="server" Width="1050px" ShowPrintButton="false"
                    ...
                    Report="FulCrumReport_Lib.MakeReady_WorkLocationImage, FulCrumReport_Lib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" Resources-ExportSelectFormatText="Export to the selected format">
