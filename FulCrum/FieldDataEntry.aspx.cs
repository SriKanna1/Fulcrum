...
namespace Fulcrum
{
    public partial class FieldDataEntry : BasePage
    {
        #region Page_Load
        ...
        protected void GetGoToPoleDetails(string PoleId, string TrackingNo)
        {
            try
            {
                DataSet ds = BAL.clsBAL_FieldDataEntry.GetPoleDetails(PoleId, TrackingNo);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtPowerMap.Text = ds.Tables[0].Rows[0]["PowerMap"].ToString();
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_Component_Id.Text != "" || txt_Component_Id.Text != null)
                {
                    FieldData.Component_Id = txt_Component_Id.Text;
                }
                else
                {
                ...
                FieldData.PowerMap = txtPowerMap.Text;
                ...
                FieldData.Ht_Class_NewFt = txt_HtClass_NewFT.Text;
                FieldData.Ht_Class_NewIn = txt_HtClass_NewInch.Text;
                ...
                //if (txtConstructionCost.Text != "$NaN")
                //{
                //    string GPC = txtConstructionCost.Text;
                //    FieldData.GPCCost = GPC.Replace('$', ' ');
                //}
                //else
                //{
                //    FieldData.GPCCost = "0";
                ...
                int result = BAL.clsBAL_FieldDataEntry.FieldData_Insert(FieldData);
                if (result > 0)
                {
                    lblMidspanInfo.Visible = false;
                    lblNotesInfo.Visible = false;
        ...
        protected void ddlTrackingNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DivViolation.Visible = false;
                FieldDataReset();
                DataSet dsMaster = BAL.clsBAL_FieldDataEntry.GetTrackingPoles(ddlTrackingNo.SelectedItem.Value);
        ...
        protected void rg_POA_InsertCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.Item.IsInEditMode)
                {
                    ...
                    int result = BAL.clsBAL_FieldDataEntry.POA_Create(objPOA);
                    if (result > 0)
                    {
            ...
            try
            {
                ...
                if (e.CommandName == "cmdDelete")
                {
                    if (e.Item.ItemIndex >= 0)
                    {
                        ...
                        int result = BAL.clsBAL_FieldDataEntry.POA_Delete(RecordId, ChildRecordId);
                        if (result > 0)
                        {
        ...
        protected void rg_Midspans_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.Item.IsInEditMode)
                {
                    ...
                    int result = BAL.clsBAL_FieldDataEntry.Midspan_Create(objmid);
                    if (result > 0)
                    {
            ...
            try
            {
                if (e.CommandName == "cmdDelete")
                {
                    if (e.Item.ItemIndex >= 0)
                    {
                        ...
                        TextBox txtChildRecordId = (TextBox)item.FindControl("txtChildRecordId");
                        string ChildRecordId = txtChildRecordId.Text.ToString();
                        int result = BAL.clsBAL_FieldDataEntry.Midspan_Delete(RecordId, ChildRecordId);
                        if (result > 0)
                        {
                            GetGoToPoleDetails(PoleId, TrackingId);
                            lblMidspanInfo.Visible = true;
        ...
        protected void rg_Notes_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.Item.IsInEditMode)
                {
                    ...
                    int result = BAL.clsBAL_FieldDataEntry.Notes_Create(objNotes);
                    if (result > 0)
                    {
            ...
            try
            {
                if (e.CommandName == "cmdDelete")
                {
                    if (e.Item.ItemIndex >= 0)
                    {
                        ...
                        int result = BAL.clsBAL_FieldDataEntry.Notes_Delete(Id, TrackingId, PoleId);
                        if (result > 0)
                        {
                            GetGoToPoleDetails(PoleId, TrackingId);
                            lblMidspanInfo.Visible = false;
