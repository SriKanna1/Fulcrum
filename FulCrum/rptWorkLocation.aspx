<%@ Page Language="C#" MasterPageFile="~/FulcrumMaster.Master" AutoEventWireup="true" CodeBehind="rptWorkLocation.aspx.cs" Inherits="Fulcrum.rptWorkLocation" %>
        ...
        <div class="container-fluid">
              <p class="pageHeading">Work Location Report</p>
                ...
                <telerik:ReportViewer ID="ReportViewer1" runat="server" Width="1050px" ShowPrintButton="false"
                    ...
                    Report="FulCrumReport_Lib.MakeReadyWorkLocations, FulCrumReport_Lib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" Resources-ExportSelectFormatText="Export to the selected format">
